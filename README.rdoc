...
Search by:
1) Location (Selected locations)
2) Date
3) Time
4) Party-size

This brings up the results of the first query: 
a list of restaurants with tables available during the specified times, and 2 time slots before and after.
